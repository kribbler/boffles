...
<div <?php post_class( $classes ); ?>>
	...
	<?php do_action( 'woocommerce_before_shop_loop_item' ); ?>
		...
		<?php 
            ...
            $url = etheme_get_image(false, 400, 400, true);
            if ($hover == 'swap') {
		...
		<div class="product_short_desc">
			<?php 
			//echo apply_filters( 'woocommerce_short_description', the_excerpt() );
			echo string_limit_words(apply_filters('woocommerce_description', $post->post_content), 10);
        ...
        <div class="view_product_details"><a href="<?php echo the_permalink(); ?>">View Product Details</a></div>
